  ...
  return (
    <div className="container mx-auto wrapper flex items-center flex-col">
      ...
      <section className="flex w-11/12 sm:w-4/5 xl:w-1/2 mt-28 sm:mt-48 flex-col" id='projects'>
        ...
        <div>
          <article className="flex mb-10 sm:mb-20 flex-col-reverse sm:flex-row">
            <div className="w-auto mt-5 sm:w-3/5 sm:mt-0 pr-2">
              ...
              <div className="flex mt-4 justify-between">
                <ul className="flex">
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">Java</li>
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">LibGDX</li>
                </ul>
                
                <ul className="flex mx-2">
                  <li className="bg-primary py-1.5 sm:py-1 px-3 rounded-md mr-4 my-1 text-xs hover:bg-secondary active:scale-105">
          ...
          <article className="flex mb-10 sm:mb-20 flex-col sm:flex-row">
            <div className="w-auto w-2/5 mt-10">
            ...
            <div className="w-auto mt-5 sm:w-3/5 sm:mt-0 pl-0 sm:pl-8">
              ...
              <div className="flex mt-4 justify-between">
                <ul className="flex">
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">React</li>
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">Firebase</li>
                </ul>
          ...
          <article className="flex mb-10 sm:mb-20 flex-col-reverse sm:flex-row">
            <div className="w-auto mt-5 sm:w-3/5 sm:mt-0 pr-2">
              ...
              <div className="flex mt-4 justify-between">
                <ul className="flex">
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">C#</li>
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">.Net</li>
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">SQL</li>
                </ul>
            ...
            <div className="w-auto mt-5 sm:w-3/5 sm:mt-0 pl-0 sm:pl-8">
              ...
              <div className="flex mt-4 justify-between">
                <ul className="flex flex-wrap">
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">JavaScript</li>
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">HTML</li>
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">CSS</li>
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">Node.js</li>
                  <li className="bg-gray-600 py-1.5 sm:py-1 px-3 rounded-full mr-4 my-1 text-xs">MongoDB</li>
                </ul>
        ...
        <div className="flex flex-col w-full h-1/2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <article className="px-4 mb-2 bg-background secondary-shadow p-5 rounded-2xl">
              ...
              <ul className="flex w-full flex-wrap">
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/html-5.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>HTML</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/css-3.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>CSS</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/js.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>JavaScript</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/react-js.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>ReactJS</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/next-js.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>Next.js</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/Tailwind-CSS.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm w-max'>TailwindCSS</p>
                </li>
              </ul>
            </article>
            {/* Back End Section */}
            <article className="px-4 mb-2 bg-background secondary-shadow p-5 rounded-2xl">
              ...
              <ul className="flex w-full flex-wrap">
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/node-js.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>Node.js</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/java.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>Java</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/c-charp.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>C#</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/dot-Net.svg" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>.Net</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/mongodb.svg" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>MongoDB</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/SQL.png" alt="" width={50} height={50} className="rounded-md object-cover" />
            ...
            <article className="px-4 mb-2 bg-background secondary-shadow p-5 rounded-2xl">
              ...
              <ul className="flex w-full flex-wrap">
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/spring.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm w-max'>Spring Boot</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/angular.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>Angular</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/python.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>Python</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/typescript.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>TypeScript</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/astro.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>Astro</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/azure.png" alt="" width={50} height={50} className="rounded-md object-cover" />
            ...
            <article className="px-4 mb-2 bg-background secondary-shadow p-5 rounded-2xl">
              ...
              <ul className="flex w-full flex-wrap">
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/Git.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>Git</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/vs-code.png" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>VSCode</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/SSMS.jpg" alt="" width={50} height={50} className="rounded-md object-cover" />
                  <p className='pt-3 text-sm'>SSMS</p>
                </li>
                <li className="p-5 w-1/3 aspect-square flex flex-col items-center justify-center">
                  <Image src="/img/technologies/IntelliJ.png" alt="" width={50} height={50} className="rounded-md object-cover" />
      ...
      <footer class="opacity-80 m-4 mt-16 w-full mx-auto container w-11/12 sm:w-4/5 xl:w-1/2 mb-10 flex justify-center"> 
        <div class="rounded-lg w-full max-w-screen-xl mx-auto flex items-center justify-between py-4"> 
          <span class="text-sm sm:text-center text-zinc-200/90">© 2024 Almost all rights reserved</span> 
          <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-white/90 sm:mt-0"> 
